...
insert  into `disease`(`disease_id`,`disease_name`,`description`,`dtype`,`how_to_cure`) values (1,'a','b','k','p'),(2,'pimples','small','Consult Doctor','get medicine'),(3,'pimples','small','Consult Doctor','get medicine');
...
insert  into `doctor`(`doctor_id`,`name`,`email`,`phone`,`qualification`) values (0,NULL,NULL,NULL,NULL),(2,'shanith','shanith1@gmail.com',123456789,'sslc');
...
insert  into `login`(`login_id`,`username`,`password`,`usertype`) values (1,'admin','admin','admin'),(2,'shanith','123','doctor');
...
insert  into `symptoms`(`symptom_id`,`disease_id`,`symptom_name`) values (1,2,'asd'),(2,1,'shivering');
