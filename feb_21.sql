...
insert  into `login`(`login_id`,`username`,`password`,`usertype`) values (1,'admin','admin','admin'),(2,'shanith','1234','doctor'),(3,'main','pass','pending'),(4,'mani@123','kk','user'),(5,'jk@gmail.com','jk','user'),(6,'j@gmail.com','kk','user'),(7,'ak@123','akshay','pending'),(8,'a@123','1234','user');
